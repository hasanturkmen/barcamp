...
<?php include($_SERVER['DOCUMENT_ROOT'].'/_/components/header.php')?>
	<div class="row-fluid">
		<div class="span12">
			<div class="hero-unit">
				...
				<p>Downtown Deland • Saturday, October 6th • 9:00 am - 5 pm</p>
	...
	<div id="info" class="row-fluid">
		<article id="primary" class="span7">
			...
			<a class="btn btn-warning" data-toggle="modal" href="/images/barcampqrcode.pdf"><i class="icon-large icon-qrcode"></i> QR Code PDF</a>
